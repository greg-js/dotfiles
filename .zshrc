...
export PATH="/usr/local/sbin:/usr/local/bin:/usr/bin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl:/usr/bin/python2:$HOME/bin:$(ruby -e 'print Gem.user_dir')/bin:$PATH"
